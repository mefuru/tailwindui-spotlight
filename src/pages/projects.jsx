...
import logoAdvaita from '@/images/logos/advaita-gpt.png'

const projects = [
  {
    name: 'AdvaitaGPT',
    description: 'A non-duality spirituality teacher GPT',
    link: {
      href: 'https://chat.openai.com/g/g-gdXCNy2cB-advaitagpt',
      label: 'AdvaitaGPT',
    },
    logo: logoAdvaita,
  },
  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Apps to help people wake up" />
      </Head>
      <SimpleLayout
        title="Apps to help people wake up"
